...
def encrypt(message: str, key: str) -> str:
    """
    encrypt function will encrypt the message using the key provided and global iv
...
def decrypt(encode_message: str, key: str) -> str:
    """
    decrypt function will decrypt the message using the key provided, encrypted message and global iv
